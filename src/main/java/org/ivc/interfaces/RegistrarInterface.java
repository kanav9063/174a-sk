...
public class RegistrarInterface {
        ...
        while (true) {
            ...
            try {
                switch (command) {
                    ...
                    case "studentgrades":
                        if (parts.length < 3) {
                            System.out.println("Usage: studentgrades <student_id> <quarter>");
                        } else {
                            db.listQuarterGrades(parts[1], parts[2]);
                        }
                        break;
    ...
    private void showHelp() {
        ...
        System.out.println("  studentgrades <student_id> <quarter> - View student's grades for a specific quarter");
